...
var g = &grammar{
	rules: []*rule{
		{
			name: "QUERY",
			pos:  position{line: 15, col: 1, offset: 216},
			expr: &actionExpr{
				pos: position{line: 15, col: 10, offset: 225},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						&labeledExpr{
							...
							label: "vals",
							expr: &oneOrMoreExpr{
								pos: position{line: 15, col: 15, offset: 230},
								expr: &seqExpr{
									pos: position{line: 15, col: 16, offset: 231},
									exprs: []interface{}{
										&ruleRefExpr{
											pos:  position{line: 15, col: 16, offset: 231},
											name: "CrumbSeparator",
										...
										&ruleRefExpr{
											pos:  position{line: 15, col: 31, offset: 246},
											name: "Ident",
										},
									},
								},
						...
						&ruleRefExpr{
							pos:  position{line: 15, col: 39, offset: 254},
							name: "EOF",
						},
					},
				},
		...
		},
		{
			...
			expr: &actionExpr{
				pos: position{line: 27, col: 10, offset: 549},
		...
		{
			name: "Char",
			pos:  position{line: 31, col: 1, offset: 599},
			expr: &charClassMatcher{
				pos:        position{line: 31, col: 9, offset: 607},
				val:        "[a-z]",
				ranges:     []rune{'a', 'z'},
				ignoreCase: false,
				inverted:   false,
		...
		{
			name: "CrumbSeparator",
			pos:  position{line: 33, col: 1, offset: 616},
			expr: &actionExpr{
				pos: position{line: 33, col: 19, offset: 634},
				run: (*parser).callonCrumbSeparator1,
				expr: &labeledExpr{
					pos:   position{line: 33, col: 19, offset: 634},
					label: "val",
					expr: &litMatcher{
						pos:        position{line: 33, col: 23, offset: 638},
						val:        ".",
						ignoreCase: false,
					},
				},
		...
		{
			name: "EOF",
			pos:  position{line: 37, col: 1, offset: 682},
			expr: &notExpr{
				pos: position{line: 37, col: 7, offset: 690},
				expr: &anyMatcher{
					line: 37, col: 8, offset: 691,
				},
			},
		},
	},
